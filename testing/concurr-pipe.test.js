...
const DOC_MAP = {
  ...
  'long.txt': Buffer.from('This is longfile................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................'),
...
test('Concurrency: should respond file content for multiple clients with correct content length when file exists.', async () => {
...
test('bad Concurrency: should respond 400 and close connections.', async () => {
  const client = createClient();
  const client1 = createClient();
  const client2 = createClient();
  const client3 = createClient();
...
test('Pipeline: should respond correct content in connection and closed after timeout', async () => {
  const client = createClient();
  await client.connect();
...
test('Pipeline: should respond correct content in connection with 404 request', async () => {
  const client = createClient();
  await client.connect();
...
test('Pipeline: where second request is malformed ', async () => {
  const client = createClient();
  await client.connect();
